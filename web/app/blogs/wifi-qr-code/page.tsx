  ...
  return (
    <Box>
      ...
      <Container size="sm" style={{ minHeight: "70vh", display: "flex", flexDirection: "column" }}>
        ...
        <Image
          src="https://images.unsplash.com/photo-1645725677294-ed0843b97d5c?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="WiFi QR Kod"
          width={500}
          height={300}
